...
export default function PatientPortalPage() {
  ...
  // Security Access Guard: Only PATIENT and DOCTOR can inspect patient medical timeline
    ...
    return (
      <div className="max-w-2xl mx-auto py-20 px-4 text-center">
        ...
        <h2 className="text-2xl font-black text-slate-900 mt-3">
          Patient Portal Access Restricted
        </h2>
        <p className="text-xs text-slate-600 max-w-md mx-auto mt-2 leading-relaxed">
          Under medical data privacy rules, Protected Health Information (PHI), lifelong timelines, and diagnostic reports can only be viewed by <strong>Verified Patients</strong> and <strong>Attending Licensed Physicians</strong>. 
          Your current session is logged as <strong>{activeRole}</strong>.
        </p>
